...
class _QRScannerScreenState extends State<QRScannerScreen> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('مسح QR للحضور', style: TextStyle(color: Colors.white)),
  ...
  void _openQRScanner() {
    // هنا يمكنك تنفيذ فتح الكاميرا لمسح QR Code
    // للآن سنعرض dialog للمحاكاة
    showDialog(
      context: context,
